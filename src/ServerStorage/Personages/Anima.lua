...
-- 				local weightObject = childPart:FindFirstChild("Weight")
-- 				if (weightObject == nil) then
-- 					self.AnimTable[name][idx].weight = 1
-- 				else
-- 					self.AnimTable[name][idx].weight = weightObject.Value
-- 				end
-- 				self.AnimTable[name].count = self.AnimTable[name].count + 1
-- 				self.AnimTable[name].totalWeight = self.AnimTable[name].totalWeight + animTable[name][idx].weight
-- 				idx = idx + 1
-- 			end
-- 		end
-- 	end
